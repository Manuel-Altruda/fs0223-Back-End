...
import com.SistemaAntiIncendio.Spring.security.exception.MyAPIException;
...
import com.SistemaAntiIncendio.Spring.security.security.JwtTokenProvider;
    ...
    public String register(RegisterDto registerDto) {
        ...
        if(registerDto.getRoles() != null) {
            registerDto.getRoles().forEach(role -> {
                Optional<Role> optionalUserRole = roleRepository.findByRoleName(getRole(role));
                Role userRole = optionalUserRole.orElseThrow(() -> new MyAPIException(HttpStatus.INTERNAL_SERVER_ERROR, "User role not found"));
                roles.add(userRole);
            });
        } else {
            Role userRole = roleRepository.findByRoleName(ERole.ROLE_USER)
                .orElseThrow(() -> new MyAPIException(HttpStatus.INTERNAL_SERVER_ERROR, "Default user role not found"));
            roles.add(userRole);
        }
